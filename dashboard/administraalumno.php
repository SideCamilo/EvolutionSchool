...
<div id="page-wrapper" class="page-wrapper-cls" >
  <div id="page-inner" style="padding: 40px; border: solid 1px #333;">
    <div class="row">
      <div class="col-md-4">
        <div class="form-group">
          ...
          <select class="form-control" id="Nivel" onchange="cambio(this); selectalumno()">
            <option>0</option>
            <option>1</option>
            <option>2</option>
            <option>3</option>
      ...
      <div class="col-md-4">
        <div class="form-group">
          ...
          <select class="form-control" id="Curso" onchange="selectalumno()">
    ...
    <div class="row">
      <div class="col-md-4">
        <button type="button" class="btn btn-primary" onclick="buscaralumno()" style="width:100%;">BUSCAR</button>
      </div>
    </div>
    <div id="informacion">
