...
<div id="page-wrapper" class="page-wrapper-cls" >
  <div id="page-inner" style="padding: 40px; border: solid 1px #333;">
    <div class="row">
      <div class="col-md-4">
        <button type="button" style="margin-top:30px; width:100%" class="btn btn-primary" onclick="newtask()">AGREGAR TAREAS</button>
      </div>
      <div class="col-md-4">
        <button type="button" style="margin-top:30px; width:100%" class="btn btn-primary" onclick="reviewtask()">REVISAR TAREAS</button>
      </div>
    </div>
    <div id="tar"></div>
  </div>
